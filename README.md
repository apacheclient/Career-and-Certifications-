...
- **CompTIA Network+** (Oct 2025 – Nov 2028)
- **CompTIA A+** (Jul 2025 – Nov 2028)
- **CompTIA Project+** (Oct 2025 – Oct 2028)
- **AWS Certified Cloud Practitioner** (May 2025 – May 2028)
- **Linux Essentials** (Jan 2026)
- **ITIL 4 Foundation in IT Service Management** (Apr 2023 – Apr 2026)

---

## Continued Learning & Career Path

**Current Focus Areas:**
- Deepening **networking** expertise (targeting CCNA)
- Advancing **cybersecurity** knowledge (CySA+, PenTest+ pathway)
- Cloud security and architecture (AWS Security / Solutions Architect)
...
**Open to opportunities in the Central Texas area (willing to relocate for the right role).**
